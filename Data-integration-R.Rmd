...
In this example there isn't much evidence for a relationship, but that might not be surprising given the fake CS locations!
...
One aspect that has not been investigated in this short tutorial but could be a useful exercise to continue improving your skills in integration would be to look at change over time. We looked at the earliest Countryside Survey and matched to an appropriate Agricultural Census but the survey has been repeated three times since then. You could look at:
